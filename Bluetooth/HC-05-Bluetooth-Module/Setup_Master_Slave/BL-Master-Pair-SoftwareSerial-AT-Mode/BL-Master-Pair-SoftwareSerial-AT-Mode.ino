...
void setup() 
{
    ...
    // For full atmode connect pin34 to D4 Ardunio
    // Comment the below two lines to run bluetooth module
    // in communication/data mode
     ...
     * Set it to 38400 for pair link and bind commands
     * AT+RNAME? 2016,1,69779
     * AT+PAIR=2016,1,69779,9
     * AT+BIND=2016,1,69779
     * AT+CMODE=1
     * AT+LINK=2016,1,69779
    */
