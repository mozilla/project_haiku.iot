...
//handles JSON requests based on the :id status number. reads file of status number provided and returns the data in json format
app.get('/api/user/:id/status', function(req, res){
...
//handles html requests based on :id, the status number. reads file of :id provided and renders html page with an update bar to update status
