            ...
            try {
               ...
               if (postBody != null && !postBody.equals("null")) {
                    if (method.equals("PUT")) {
                        Log.v(LOG_TAG, "execute punam: check method = ");
                        requestBuilder.put(RequestBody.create(MEDIA_TYPE_MARKDOWN, postBody.toString()));
                    } else {
                        Log.v(LOG_TAG, "execute punam: check method1 = ");
